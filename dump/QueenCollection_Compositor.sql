...
CREATE TABLE `Compositor` (
  ...
  CONSTRAINT `compositor_ibfk_1` FOREIGN KEY (`composition_id`) REFERENCES `Composition` (`id`),
  CONSTRAINT `compositor_ibfk_2` FOREIGN KEY (`author_id`) REFERENCES `Artist` (`id`)
