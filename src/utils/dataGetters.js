...
import { groupBy, map, sortBy, sortByReleaseDate, sortNonQueenEntries, values } from './dataHelpers'
...
export const getNonQueenEntries = () => api.fetchNonQueenEntries().then(sortNonQueenEntries)
