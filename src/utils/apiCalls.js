...
export const fetchArtistTypes = (artistID) =>
  fetchData(`types?artist=${artistID}`);
export const fetchEntries = (artistID, type) =>
  fetchData(`entries?artist=${artistID}&type=${type}`);
export const fetchReleases = (entryID) =>
  fetchData(`releases?entry=${entryID}`);
...
export const fetchReleaseTracks = (releaseID) =>
  fetchData(`tracks?release_id=${releaseID}`);
...
export const fetchMovies = () => fetchData("movies");

export const postNewRelease = (release) =>
  fetchData("release", "POST", release, {
    "Content-Type": "application/json",
  });

export const updateRelease = (release) =>
  fetchData("release", "PUT", release, {
    "Content-Type": "application/json",
  });
